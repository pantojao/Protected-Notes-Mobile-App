...
export const NoteOptions = ({ noteName, hideModal, editNoteName, deleteThis, moveNote }) => {
	...
	return (
		<>
			...
			{showingMove && <MoveNotePortal moveNote={moveNote} hideMoveMenu={hideMoveMenu} />}
...
const MoveNotePortal = ({ moveNote, hideMoveMenu }) => {
	...
	return (
		<Portal>
			<Dialog visible={true} onDismiss={hideMoveMenu}>
				<Dialog.ScrollArea>
					<ScrollView>
						<RadioButton.Group onValueChange={(newValue) => setLocation(newValue)} value={location}>
